...
from ZEFRONMUSIC.utils.decorators.admins import ActualAdminCB
from ZEFRONMUSIC.utils.decorators.language import language, languageCB
from ZEFRONMUSIC.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from ZEFRONMUSIC.utils.inline.start import private_panel
...
async def gib_repo_callback(_, callback_query):
    await callback_query.edit_message_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(text="• بازگشت •", callback_data="back_cb", style=ButtonStyle.PRIMARY),
                    InlineKeyboardButton(text="• بستن •", callback_data="close", style=ButtonStyle.DANGER)
                ]
            ]
        ),
    )
