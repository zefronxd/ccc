...
from ZEFRONMUSIC.core.call import PURVI as Anony
from ZEFRONMUSIC.misc import db, SUDOERS
from ZEFRONMUSIC.utils import AdminRightsCheck, seconds_to_min
from ZEFRONMUSIC.utils.inline import close_markup
from config import BANNED_USERS

@app.on_message(
    filters.command(
        ["seek", "cseek", "seekback", "cseekback", "جلو", "عقب"],
        prefixes=["", "/", "!", "%", ",", ".", "@", "#"],
    )
    & filters.group
    & ~BANNED_USERS
