...
from ZEFRONMUSIC.utils.database import add_sudo, remove_sudo
from ZEFRONMUSIC.utils.decorators.language import language
from ZEFRONMUSIC.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message):
    keyboard = [[InlineKeyboardButton("๏ مشاهده کاربران ارشد ๏", callback_data="check_sudo_list")]]
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        ...
        keyboard.append([InlineKeyboardButton("๏ مشاهده مالک ๏", url=f"tg://openmessage?user_id={OWNER_ID}")])
