...
from ZEFRONMUSIC.utils.inline import botplaylist_markup
        ...
        if await is_maintenance() is False:
            if message.from_user.id not in SUDOERS:
                return await message.reply_text(
                    text=f"{app.mention} در حالت تعمیر و نگهداری است. برای اطلاع از دلیل، به <a href={SUPPORT_CHAT}>گروه پشتیبانی</a> سر بزنید.",
            ...
            try:
                ...
                return await message.reply_text(
                    _.get(
                        ...
                        "دستیار پخش هنوز آماده نیست. لطفاً چند لحظه بعد دوباره تلاش کنید.",
                    )
                )
            try:
                try:
